        ...
        <form action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                    class="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 dark:bg-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500">{{ $category->description }}</textarea>
            </div>
            <div>
            ...
            <div>
                <x-button type="success" icon="bi bi-save" :submit="true">Update</x-button>
            </div>
        </form>
    </div>
</x-app-layout>
